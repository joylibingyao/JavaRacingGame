...
public class Game extends JPanel implements ActionListener  {
    ...
    private final double initCar_x = 120;
    private final double initCar_y = 550;
    private final double initTraffic_x = 0;
    ...
    public void initLanes() {
        ...
        for (int i = 1; i<3;i++){//
            for (int j = 0; j<7;j++){//verical
                lanes.add(new Lanes(i*94,j*190,(double)speedOption*0.5));
    ...
    private void inGame() {
        ...
        if (!ingame) {
            ...
            lostLabel.setFont(new Font("Serif", 1, 20));
